...
function Teste() {
  ...
  const opcoesCrimes = ["Roubo de celular", "Roubo de motocicletas", "Roubo à residência", "Roubo de automóveis", "Roubo a comércio", "Roubo de camionete", "Roubo a veículo de aplicativo", "Roubo a transeunte", "Furto de celular", "Furto de motocicletas", "Furto à residência", "Furto de automóveis", "Furto a comércio", "Furto de camionete", "Furto a veículo de aplicativo", "Furto a transeunte", "Tráfico de drogas", "Tráfico de armas", "Homicídio doloso", "Porte de armas", "Estelionato", "Estupro", "Latrocínio"];
